...
function New-AzAdvertizerDiffIssue {
  ...
  $latestWorkflowRunId = gh run list --repo $Repo --workflow $Workflow --branch 'main' --limit 1 --json 'databaseId' | ConvertFrom-JSON | Select-Object -First 1 -ExpandProperty 'databaseId'
