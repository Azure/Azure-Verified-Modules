...
.EXAMPLE
Get-GitHubWorkflowLatestRun -RepositoryOwner 'Azure' -RepositoryName 'Azure-Verified-Modules' -WorkflowId '447791597'

Get the latest workflow run of the repository [Azure/Azure-Verified-Modules] for a workflow with id '447791597', filtered to the 'main' branch.
#>
function Get-GitHubWorkflowLatestRun {
