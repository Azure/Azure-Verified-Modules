...
description: Experimental features and emerging technologies being explored by the Azure Verified Modules (AVM) team.
---
...
{{% notice style="info" title="Your feedback is welcome!" %}}
...
Provide feedback through [GitHub Issues](https://aka.ms/AVM/QuestionFeedback).
