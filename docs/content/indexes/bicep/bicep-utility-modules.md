...
{{% moduleNameStatusOwners header=true csv="/static/module-indexes/BicepUtilityModules.csv" language="Bicep" moduleType="utility" include="Available :green_circle:,Orphaned :eyes:" %}}
...
{{% moduleNameStatusOwners header=true csv="/static/module-indexes/BicepUtilityModules.csv" language="Bicep" moduleType="utility" include="Proposed :new:" %}}
...
{{% moduleNameStatusOwners header=true csv="/static/module-indexes/BicepUtilityModules.csv" language="Bicep" moduleType="utility" include="Available :green_circle:,Orphaned :eyes:Proposed :new:,Deprecated" %}}
