    ...
    roleAssignments: [
      {
        ...
        roleDefinitionIdOrName: 'Key Vault Secrets User' // Allows read access to secrets
      }
    ]
  }
}
      ...
      roleAssignments:[
        {
          principalId: virtualMachine.outputs.systemAssignedMIPrincipalId
          principalType: 'ServicePrincipal'
          roleDefinitionName: 'Storage Blob Data Contributor' // Allows read/write/delete on blob containers
        }
      ]
    }
    privateEndpoints: [
