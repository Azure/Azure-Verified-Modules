...
This page provides guidance for **Terraform Module (TFM) owners** on how to triage **AVM module issues** and **AVM question/feedback** items filed in their Terraform Module Repo, as well as how to manage these GitHub issues throughout their lifecycle.

As such, **the following issues are to be filed in the TFM repository**:
...
Do **NOT** file the following types of issues in the **TFM repository**, as they **MUST** be tracked in the **AVM repo**:
