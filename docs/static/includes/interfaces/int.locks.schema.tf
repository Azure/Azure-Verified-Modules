...
- `kind` - (Required) The type of lock. Possible values are `null`, `CanNotDelete` and `ReadOnly`.
...
DESCRIPTION
  ...
  validation {
    ...
    error_message = "The lock level must be one of: `null`, `CanNotDelete` and `ReadOnly`."
  }
}
